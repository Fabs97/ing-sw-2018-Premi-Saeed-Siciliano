...
public class SchemeCardHandlerTest {
    ...
    public void buildCustomCard() {
        ...
        when(asker.askString("Nome non valido. Inseriscine uno giusto!")).thenReturn("Pippo-Topolino");
        SCH.buildCustomCard("LuxMondi", "4", frontCellNumbers1, frontCellColors1, "LuxAstram", "5", frontCellNumbers2, frontCellColors2, asker);
    */}
    ...
    public void removeCustomCard() {
        Assert.assertTrue(SCH.removeCustomCard("LuxMondi-LuxAstram"));
        Assert.assertFalse(SCH.removeCustomCard("Pippo-Pluto"));
    }
}