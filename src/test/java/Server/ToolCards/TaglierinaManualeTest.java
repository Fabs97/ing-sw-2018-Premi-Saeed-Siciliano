...
public class TaglierinaManualeTest {
    ...
    public void moveDices() {
        ...
        //first test
        /*try{
            TaglierinaManuale.moveDices(roundTrace, 0, 0, scheme, 2,1, 0,3, 2, 2, 1,4);
        }
        ...
        //second test
        try{
            TaglierinaManuale.moveDices(roundTrace, 9, 0, scheme, 0,3, 0,3, 1, 4, 1,4);
        }
        catch (IllegalRoundException e){}
        catch (WrongInputException e){}
        //catch (CannotPlaceDiceException e){}
        ...
        //third test
        try{
            TaglierinaManuale.moveDices(roundTrace, 0, 0, scheme, 0,3, 0,0, 1, 4, 3,4);
        }
        catch (IllegalRoundException e){}
        catch (WrongInputException e){}
        //catch (CannotPlaceDiceException e){}

        Assert.assertEquals(dice3D, scheme.getScheme()[0][3].getDado());
        Assert.assertEquals(dice2D, scheme.getScheme()[1][4].getDado());
