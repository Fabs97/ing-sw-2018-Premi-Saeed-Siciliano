...
public class SchemeController extends UnicastRemoteObject implements SchemeInterface {
    ...
    @Override
    public void saveCardOnServer(String[] names, String[] favors, String[] scheme1, String[] scheme2) throws RemoteException{
        ...
        SchemeCardMapper.getCardMapper().saveNewCard(names[0], favors[0], scheme1Numbers, scheme1Colors, names[1], favors[1], scheme2Numbers, scheme2Colors);
    }
